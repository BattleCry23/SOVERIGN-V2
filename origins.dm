			...
			proc
				activate(var/mob/m,var/obj/s)
					...
					switch(m.race)
						if("Makyo")
							if(m.skin_pos == 1)
								m.icon= 'makyo_kid.dmi'


							if(m.skin_pos == 2)
								m.icon= 'makyo_kidred.dmi'


							if(m.skin_pos == 3)
								m.icon= 'makyo_kidtan.dmi'


							if(m.skin_pos == 4)
								m.icon= 'makyo_kidpurple.dmi'

						if("Human")
							switch(m.gen)
								if("Male")
									if(m.skin_pos == 1)
										m.icon = 'human_male_white_kid.dmi'

									if(m.skin_pos == 2)
										m.icon = 'human_male_tan_kid.dmi'


									if(m.skin_pos == 3)
										m.icon = 'human_male_black_kid.dmi'


								if("Female")
									if(m.skin_pos == 1)
										m.icon = 'human_female_white_kid.dmi'

									if(m.skin_pos == 2)
										m.icon = 'human_female_tan_kid.dmi'

									if(m.skin_pos == 3)
										m.icon = 'human_female_black_kid.dmi'
						...
						if("Demon")
							switch(m.gen)
								if("Male")
									if(m.skin_pos == 1)
										m.icon = 'Humanoid_Kid_Colorable.dmi'
								...
								if("Female")
									if(m.skin_pos == 1)
										m.icon = 'humanoid_no_colour_female2_kid.dmi'
						...
						if("Kai")
							switch(m.gen)
								if("Male")
									m.icon='humanoid_no_colour2_kid.dmi'
						...
						if("Oni")
							if(m.skin_pos == 1)
								m.icon= 'oni_male_light_kid.dmi'


							if(m.skin_pos == 2)
								m.icon= 'oni_male_dark_kid.dmi'
						...
						if("Namekian")
							if(m.skin_pos == 1)
								m.icon = 'NewKidNamekian4.dmi'


							if(m.skin_pos == 2)
								m.icon = 'NewKidNamekian3.dmi'



							if(m.skin_pos == 3)
								m.icon = 'NewKidNamekian2.dmi'


							if(m.skin_pos == 4)
								m.icon = 'NewKidNamekian1.dmi'
						...
						if("Spirit Doll")
							if(m.skin_pos == 1)
								m.icon= 'spiritdoll_kid.dmi'


							if(m.skin_pos == 2)
								m.icon= 'spiritdoll_kidtan.dmi'


						if("Changeling")
							if(m.skin_pos == 1)
								m.icon= 'Frieza_1st_form_kid.dmi'

							if(m.skin_pos == 2)
								m.icon= '1stFriezaKid_Blue.dmi'

							if(m.skin_pos == 3)
								m.icon= '1stFriezaKid_Green.dmi'


							if(m.skin_pos == 4)
								m.icon= '1stFriezaKid_Orange.dmi'


							if(m.skin_pos == 5)
								m.icon= '1stFriezaKid_Red.dmi'

						if("Alien")
							if(m.skin_pos == 1)
								m.icon= 'alien_captginyu_kid.dmi'


							if(m.skin_pos == 2)
								m.icon = 'alien_immecka_kid.dmi'


							if(m.skin_pos == 3)
								m.icon = 'alien_kanassa_kid.dmi'



							if(m.skin_pos == 4)
								m.icon = 'alien_kui_kid.dmi'


							if(m.skin_pos == 5)
								m.icon = 'alien_yardrat_kid.dmi'
				...
				activate(var/mob/m,var/obj/s)
					...
					switch(m.race)
						if("Makyo")
							...
							if(m.skin_pos == 2)
								m.icon = 'makyo_red.dmi'


							if(m.skin_pos == 3)
								m.icon = 'makyo_tan.dmi'


							if(m.skin_pos == 4)
								m.icon = 'makyo_purple.dmi'

						if("Human")
							switch(m.gen)
								if("Male")
									if(m.skin_pos == 1)
										m.icon = 'NewMalesWhite.dmi'

									if(m.skin_pos == 2)
										m.icon = 'NewMalesTan.dmi'


									if(m.skin_pos == 3)
										m.icon = 'NewMalesBlack.dmi'


								if("Female")
									if(m.skin_pos == 1)
										m.icon = 'FemaleBaseWhite.dmi'
									if(m.skin_pos == 2)
										m.icon = 'FemaleBaseTan.dmi'

									if(m.skin_pos == 3)
										m.icon = 'FemaleBaseBlack.dmi'
						...
						if("Demon")
							switch(m.gen)
								if("Male")
									if(m.skin_pos == 1)
										m.icon = 'demon_default_male.dmi'


									if(m.skin_pos == 2)
										m.icon = 'demon_male.dmi' // change to colorable skin
								...
								if("Female")
									if(m.skin_pos == 1)
										m.icon = 'demon_default_female.dmi'
											//target.overlays += target.body_horns

									if(m.skin_pos == 2)
										m.icon = 'demon_female.dmi' // Change to colorable skin
											//target.overlays += target.body_horns
						...
						if("Kai")
							switch(m.gen)
								if("Male")
									m.icon='humanoid_no_colour2.dmi'

								if("Female")
									m.icon='humanoid_no_colour_female2.dmi'



						if("Oni")
							if(m.skin_pos == 1)
								m.icon = 'oni_male_light.dmi'
									//target.overlays += target.body_horns


							if(m.skin_pos == 2)
								m.icon = 'oni_male_dark.dmi'
								//	target.overlays += target.body_horns
						...
						if("Namekian")
							if(m.skin_pos == 1)
								m.icon = 'NewNamekianAdult4.dmi'


							if(m.skin_pos == 2)
								m.icon = 'NewNamekianAdult3.dmi'


							if(m.skin_pos == 3)
								m.icon = 'NewNamekianAdult2.dmi'


							if(m.skin_pos == 4)
								m.icon = 'NewNamekianAdult1.dmi'
						...
						if("Spirit Doll")
							if(m.skin_pos == 1)
								m.icon = 'spiritdoll.dmi'


							if(m.skin_pos == 2)
								m.icon = 'spiritdoll_tan.dmi'


						if("Changeling")
							if(m.skin_pos == 1)
								m.icon = 'Frieza_1st_form.dmi'


							if(m.skin_pos == 2)
								m.icon = '1stFriezaBlue.dmi'

							if(m.skin_pos == 3)
								m.icon = '1stFriezaGreen.dmi'

							if(m.skin_pos == 4)
								m.icon = '1stFriezaOrange.dmi'


							if(m.skin_pos == 5)
								m.icon = '1stFriezaRed.dmi'



						if("Alien")
							if(m.skin_pos == 1)
								m.icon = 'Alien_Captin_Ginyu_Naked.dmi'


							if(m.skin_pos == 2)
								m.icon =  'Alien_Immecka_Naked.dmi'



							if(m.skin_pos == 3)
								m.icon = 'Alien_Kanassa_Naked.dmi'


							if(m.skin_pos == 4)
								m.icon ='Alien_Kui_Naked.dmi'


							if(m.skin_pos == 5)
								m.icon ='Alien_Yardrat_Naked.dmi'
...
mob/proc/apply_zenkai(var/mob/m)
    if(!src || (!src.race == "Saiyan" && !src.zenkai_mutation)) return
...
mob/proc/zenkai_pool_gain(var/damage_percent)
    ...
    if(!(src.race == "Saiyan" || src.zenkai_mutation)) return
    if(src.koed) return

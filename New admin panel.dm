	...
	// =========================
		...
		if("Planet_Teleport")
			switch(input("Where are you teleporting too?") in list("Earth","Namek","Vegeta","Icer","Other Realm","Heaven","Hell","Dark Realm","Space"))
				if("Earth")
					src.projection.loc = locate(rand(5,480), rand(5,480), 1)
				if("Namek")
					src.projection.loc = locate(rand(5,480), rand(5,480), 4)
				if("Vegeta")
					src.projection.loc = locate(rand(5,480), rand(5,480), 10)
				if("Icer")
					src.projection.loc = locate(rand(5,480), rand(5,480), 9)
				if("Other Realm")
					src.projection.loc = locate(rand(5,480), rand(5,480), 2)
				if("Heaven")
					src.projection.loc = locate(rand(5,480), rand(5,490), 11)
				if("Hell")
					src.projection.loc = locate(rand(5,480), rand(5,480), 6)
				if("Dark Realm")
					src.projection.loc = locate(rand(5,480), rand(5,480), 12)
				if("Space")
					src.projection.loc = locate(rand(5,480), rand(5,480), 16)
